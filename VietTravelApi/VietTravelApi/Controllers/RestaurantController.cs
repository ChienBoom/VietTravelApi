...
namespace VietTravelApi.Controllers
{
    ...
    public class RestaurantController : Controller
    {
        ...
        public Jwt _jwt;
        public int pageSize;
        public RestaurantController(DataContext dataContext, IConfiguration configuration, DeleteModels deleteModels, Jwt jwt)
        {
        ...
        public IActionResult Put(long id, [FromBody] Restaurant value)
        {
            try
            {
                ...
                if (restaurant != null)
                {
                    ...
                    value.NumberOfEvaluate = restaurant.NumberOfEvaluate;
                    value.MediumStar = restaurant.MediumStar;
